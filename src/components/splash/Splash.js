    ...
    render(){
        ...
        return(
            <div className="hdt-SplashBacking hda-CenterText">
                <div className="hdo-SplashBacking hdo-SplashDiv hda-CenterText">
                    ...
                    <Button className="hda-btn-primary-solid-alt" href="/login">LOGIN</Button>
                    <Button className="hda-btn-primary-solid" href="/register">REGISTER</Button>
