    ...
    render(){
      ...
      <div className="hdo-DivBacking">
        ...
        <Form onSubmit={this.handleSubmit}>
          <FormGroup>
            <Button className="hda-btn-secondary-default" type="submit" value={e.target.value}>Yes</Button>
            <Button className="hda-btn-secondary-alert" type="submit" value={e.taget.value}>No</Button>
          </FormGroup>
        </Form>
