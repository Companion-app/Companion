    ...
    render(){
      ...
      <div className="hdo-DivBacking">
        ...
        <Form onSubmit={this.handleSubmit}>
          <FormGroup>
            <Button className="hda-btn-secondary-default" id="yes" type="submit" value="Yes">Yes</Button>
            <Button className="hda-btn-secondary-alert" id="no" type="submit" value="No">No</Button>
          </FormGroup>
        </Form>
