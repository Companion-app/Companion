...
import { useSwipeable, Swipeable, onSwipedLeft } from 'react-swipeable';
...
class MoodList extends React.Component{
    ...
    render(){
      ...
      //   onSwiped: (dir) => eventHandler(onSwipedLeft), ...trackMouse })
      ...
      return (
        <div className="div-backing">
          ...
          {modal}
          {alert}
          <Swipeable onSwiped={(dir) => onSwipedLeft} {...trackMouse}>
            You can swipe here!
          </Swipeable>
