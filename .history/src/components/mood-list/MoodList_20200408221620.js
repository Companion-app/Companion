...
class MoodList extends React.Component{
    ...
    render(){
      ...
      let showSubmit;
      if (Object.keys(this.state.intensity).length){
        showSubmit = <Button className="btn-primary-solid" onClick={this.handleOpenAddModal}>Submit</Button>
