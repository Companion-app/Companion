...
class MedList extends React.Component{
    ...
    submitEdit() {
      axios.put('http://localhost:5000/edit-med', {oldMed: this.state.medSelected, newMed: this.state.editValue, notes: this.state.notesEditValue}, { withCredentials: true })
        .then(res => {
        let updatedMeds = this.state.meds;
    ...
    render(){
      ...
      if(this.state.showAddModal) {
        ...
        <ReactModal
          ...
          <input class="input-default" type="text" name="edit-med-notes" onChange={this.onNotesEditChange}/>
